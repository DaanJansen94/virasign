...
| `NC_004296.1/`, `NC_006577.2/`, `NC_045512.2/` | Per-virus outputs (examples): `NC_004296.1.fasta`, `NC_004296.1.bam`, `NC_004296.1_mapped_reads.fastq.gz` (and similarly for each accession folder) |
